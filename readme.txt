Encontré dos archivos .py, con los nombres "Functions" y "Main" En la parte de Functions encontré una función de suma (def suma), en Main se 
llamaba la función y se ejecutaba. 
